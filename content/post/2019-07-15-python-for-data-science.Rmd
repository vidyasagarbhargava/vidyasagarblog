...
Every python object contains the reference to a string, known as *doc string*, which contain a concise summary of the object and  how to use it. Python has built-in `help()` function that can 
access this information and prints the result.  
