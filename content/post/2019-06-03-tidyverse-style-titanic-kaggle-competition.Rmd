...
#thumbnailImage: /img/titanic.gif
---



This tutorial is an effort of showing a new approach of modelling in R using tidyverse and tidymodels. In this tutorial we are using titanic dataset from [Kaggle](https://www.kaggle.com/) competition.  
